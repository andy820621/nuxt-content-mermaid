...
export type ArgumentsType<T> = T extends (...args: infer U) => unknown ? U : never
...
// https://stackoverflow.com/questions/55541275/typescript-check-for-the-unknown-type
export type IfAny<T, Y, N> = 0 extends (1 & T) ? Y : N
/**
 * will return `true` if `T` is `unknown`, or `false` otherwise
 */
