...
接著，對齊這些版本，並重試[開始使用](/zh/getting-started#install)中的未指定版本安裝命令。在除錯此模組前，請先解決資料庫連接器的問題。
...
接著移除所有套件選項，只保留模組註冊並進行建置。如果成功，請一次還原一組選項，並參考[升級至 v3](/zh/migration/v3)了解邊界的變更。
...
- [開始使用](/zh/getting-started#add-your-first-diagram)中的三節點範例也以相同方式失敗。
