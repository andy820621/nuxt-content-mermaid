...
For more information about Mermaid themes, diagram options, security settings, and directives, see the [official Mermaid configuration documentation](https://mermaid.js.org/config/configuration.html).
